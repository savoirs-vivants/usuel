            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="px-8 pb-8">
                    <form class="space-y-5" action="{{ route('login.submit') }}" method="POST">
                        ...
                        @if ($errors->any())
                            <div class="mt-4 p-3 rounded-lg bg-red-50 border border-red-200 text-red-600 text-xs font-bold">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('password', this)"
                                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-sv-green">
                                ...
                                <div class="flex justify-end mt-1 mb-1">
                                    <a href="{{ route('password.forgot') }}"
                                        class="text-xs font-bold text-gray-400 hover:text-sv-green transition-colors">
                                        Mot de passe oublié ?
                                    </a>
                                </div>
                            </div>
