                    ...
                    <table id="table-users" class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-100">
                                <th class="text-left px-6 py-4 font-bold text-sv-blue text-xs uppercase tracking-wider">Nom</th>
                                <th class="text-left px-6 py-4 font-bold text-sv-blue text-xs uppercase tracking-wider">Email</th>
                                <th class="text-left px-6 py-4 font-bold text-sv-blue text-xs uppercase tracking-wider">Rôle</th>
                                <th class="text-left px-6 py-4 font-bold text-sv-blue text-xs uppercase tracking-wider">Structure</th>
                                <th class="text-left px-6 py-4 font-bold text-sv-blue text-xs uppercase tracking-wider">Actions</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50/80 transition-colors duration-100"
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold
                                            ...
                                            @elseif($user->role === 'gestionnaire') Gestionnaire
                                            @else Travailleur social @endif
                                        </span>
                                    </td>
