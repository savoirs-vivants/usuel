        ...
        <div class="ml-64 flex-1 p-8">
            ...
            <div x-data="{
                ...
                submitBulkDelete() {
                    ...
                    form.method = 'POST';
                    form.action = '{{ route('backoffice.destroyMultiple') }}';
                ...
                <div x-show="confirmBulkDelete" x-cloak
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
                        ...
                        <p class="text-gray-400 text-sm text-center mb-6">
                            ...
                            compte<span x-show="selected.length > 1">s</span>. Cette action est irréversible.
                        </p>
                                        ...
                                        <td class="px-5 py-4">
                                            <button @click="toggle({{ $user->id }})"
                                                ...
                                                :class="selected.includes({{ $user->id }}) ? 'bg-sv-blue border-sv-blue' :
                                                    'border-gray-300 hover:border-sv-blue bg-white'">
                                                <svg x-show="selected.includes({{ $user->id }})"
