    <section class="min-h-screen bg-gray-50 flex flex-col pt-12">
        ...
        <div class="min-h-screen bg-white flex flex-col" x-data="{
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="text-center">
                            <p class="text-xs font-semibold uppercase tracking-widest text-[#1a9e7e] mb-6">Test terminé
                            </p>

                            <div
                                class="w-20 h-20 rounded-full bg-emerald-50 flex items-center justify-center mx-auto mb-6">
                            ...
                            <p class="text-sm text-gray-500 max-w-xs mx-auto mb-8">
                                Veuillez maintenant rendre l'appareil au travailleur social pour qu'il puisse consulter
                                les résultats.
                            </p>
            ...
            @elseif ($currentQuestion)
                <div id="q-meta-data" data-qid="{{ $currentQuestion->id }}" data-pos="{{ $currentIndex }}"
                    class="hidden"></div>
                ...
                <div class="flex-1 pt-14" style="height: calc(100vh - 3.5rem); overflow: hidden;">
                    ...
                    @if ($currentQuestion->image)
                        <div class="h-full grid grid-cols-2">
                            <div
                                class="h-full bg-gray-50 border-r border-gray-100 flex items-center justify-center p-6">
                                ...
                                <div class="space-y-2.5 mb-7">
                                    @foreach ($translatedChoix as $lettre => $choixData)
                                        ...
                                        {{ $selectedAnswer === $lettre
                                            ...
                                            <div
                                                class="w-5 h-5 shrink-0 rounded-full border-2 flex items-center justify-center
                    ...
                    @else
                        <div class="h-full flex flex-col items-center justify-center px-6">
                            <div class="w-full max-w-3xl flex flex-col items-center">
                                ...
                                <div class="w-full space-y-3 mb-8">
                                    @foreach ($translatedChoix as $lettre => $choixData)
                                        ...
                                        {{ $selectedAnswer === $lettre ? 'border-[#1a9e7e]' : 'border-gray-400 bg-white' }}">
                                            ...
                                            <span data-audio-choix class="text-gray-700 font-medium">
                                                {{ $choixData['texte'] ?? $choixData }}
                                            </span>
                                        </button>
                                    @endforeach
                                ...
                                @if ($showError)
                                    <div
                                        class="w-full text-center text-red-500 text-sm font-semibold mb-4 flex items-center justify-center gap-2">
                                        <svg class="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                                                clip-rule="evenodd" />
