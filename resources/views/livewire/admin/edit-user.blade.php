        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-8">
                <a href="{{ route('backoffice') }}"
                    class="inline-flex items-center gap-2 text-sm font-semibold text-[#9ca3af] hover:text-[#1a2340] transition-colors duration-200 mb-6">
                ...
                <p class="text-sm text-gray-500 font-sans">
                    Mise à jour du profil de <span class="font-bold text-[#1a2340]">{{ $user->firstname }}
            ...
            <form wire:submit.prevent="save">
                ...
                <div
                    class="bg-white rounded-[20px] border border-[#e5e7eb] p-8 mb-8 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">

                    <div class="flex items-center gap-3 mb-8 pb-5 border-b border-[#e5e7eb]">
                        <div
                            class="w-9 h-9 rounded-[10px] bg-[#e8f5f2] text-[#16987C] flex items-center justify-center shrink-0">
                ...
                <div class="flex items-center justify-between pt-2">
                    <a href="{{ route('backoffice') }}"
                        class="inline-flex items-center gap-2 text-[#6b7280] font-semibold text-sm transition-colors duration-200 hover:text-[#1a2340]">
                        Annuler
                    </a>
                    <button type="submit" wire:loading.attr="disabled" wire:target="save"
                        ...
                        <svg wire:loading wire:target="save" class="animate-spin w-5 h-5" fill="none"
                            viewBox="0 0 24 24">
