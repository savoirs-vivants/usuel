<div>
    ...
    @if ($isOpen)
        <div
            class="fixed inset-0 z-50 flex items-center justify-center bg-sv-blue/80 backdrop-blur-sm transition-opacity">
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative">
                ...
                <form wire:submit.prevent="save" class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-sv-blue mb-1">Email <span
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-bold text-sv-blue mb-1">Rôle <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="mt-6 flex justify-end gap-3 pt-4 border-t border-gray-100">
                        ...
                        <button type="submit"
                            class="px-5 py-2.5 rounded-xl font-bold text-sm bg-sv-green text-white hover:opacity-90 transition-opacity flex items-center gap-2">
                            Enregistrer
                        </button>
                    </div>
