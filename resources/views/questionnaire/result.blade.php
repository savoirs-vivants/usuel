...
<head>
    ...
    <style>
        ...
        .dot-grid {
            ...
            background-image: radial-gradient(circle, rgba(26,35,64,0.07) 1px, transparent 1px);
        ...
        .card {
            ...
            box-shadow: 0 1px 3px rgba(26,35,64,0.06), 0 4px 16px rgba(26,35,64,0.04);
        }
    </style>
</head>

<body class="antialiased h-screen flex flex-col dot-grid">
