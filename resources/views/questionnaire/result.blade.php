...
@endphp
    ...
    <div class="flex-1 flex gap-5 px-8 pb-6 min-h-0">
        ...
        <div class="w-56 shrink-0 flex flex-col gap-3">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4 flex flex-col items-center text-center">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col items-center flex-1 justify-center">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3 space-y-2">
                ...
                <div class="flex items-center gap-1.5 pt-1 border-t border-gray-100">
                    ...
                    <span class="text-[10px] text-emerald-700 font-medium">Données partagées</span>
                </div>
                @endif
            </div>
        ...
        <div class="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col min-w-0">
            <p class="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-4 text-center">Profil de compétences</p>
